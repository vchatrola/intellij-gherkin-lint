...
public class Constants {
  ...
  public static final List<String> GHERKIN_KEYWORDS =
      List.of("Scenario", "Meta", "Given", "When", "Then", "And", "But", "*", "@");
  ...
  public static final String DEFAULT_TOOL_WINDOW_TEXT =
      "Select Gherkin text and right-click to validate.";
  public static final String NO_GHERKIN_TEXT_SELECTED_ERROR =
      "No Gherkin text selected for validation. Please select "
          + "some text containing a Gherkin statement and try again.";
  public static final String GHERKIN_TEXT_TOO_SHORT_ERROR =
      "Selected text is too short. Valid Gherkin text typically "
          + "contains at least 3 words. Please select a longer Gherkin text for validation.";
  public static final String GHERKIN_NO_CONTEXT_ERROR =
      "The selected Gherkin text includes an 'And', 'But', or '*' step without context. "
  ...
  public static final String VALIDATION_THROTTLED_ERROR =
  ...
  public static final String GEMINI_SERVICE_ACCESS_ERROR =
      "Unable to access GeminiService. Please ensure the service is properly "
